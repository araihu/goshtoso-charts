...
func TestAllKinds(t *testing.T) {
	t.Parallel()
	want := []Kind{KindHeartbeat, KindLineChart, KindBarChart, KindPieChart, KindInteractiveECharts, KindEChartsBar, KindEChartsLine, KindEChartsScatter, KindEChartsEffectScatter}
	got := AllKinds()
	if len(got) != len(want) {
