...
func TestCandlestickDefaultSVGCompatibilityHash(t *testing.T) {
	...
	if got := sha256.Sum256([]byte(svg)); got != [32]byte{0xf1, 0xe0, 0x03, 0x66, 0xfa, 0xe8, 0x0a, 0x1f, 0x99, 0x44, 0x20, 0xc7, 0x09, 0x9c, 0xaf, 0x7f, 0xb8, 0x71, 0xc3, 0xdc, 0xf0, 0x78, 0x66, 0x49, 0xc6, 0x07, 0x68, 0xbe, 0x63, 0xdc, 0x0c, 0x1e} {
