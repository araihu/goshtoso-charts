...
// Radar builds a reusable go-echarts radar component.
func Radar(cfg RadarConfig) Instance {
	if err := validateRadarConfig(cfg); err != nil {
		return newInvalidInstance(chartcomponents.KindEChartsRadar, err)
	}
	...
	return newInstance(chartcomponents.KindEChartsRadar, Config{
