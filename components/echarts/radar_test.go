...
func TestRadarRendersTypedChart(t *testing.T) {
	...
	instance := Radar(RadarConfig{
		...
		Series: []RadarSeries{{
			...
			Options: []charts.SeriesOpts{charts.WithAreaStyleOpts(opts.AreaStyle{Opacity: opts.Float(0.2)})},
		}},
		Width: "720px", Height: "360px",
		GlobalOptions: []charts.GlobalOpts{charts.WithTitleOpts(opts.Title{Title: "Health"}), charts.WithColorsOpts(opts.Colors{"#000000"})},
		SeriesOptions: []charts.SeriesOpts{charts.WithLineStyleOpts(opts.LineStyle{Width: 2})},
		Style:         charttheme.Style{Palette: charttheme.PaletteAraiHu, Colors: []string{"#123456"}, Class: "min-h-80"},
	})

	if instance.Kind() != chartcomponents.KindEChartsRadar {
