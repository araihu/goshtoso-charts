...
func TestPieRendersSSRAccessibleSVG(t *testing.T) {
	...
	for _, want := range []string{"<figure class=\"goshtoso-charts-pie\" role=\"img\" aria-label=\"Deployments by status\"", "<svg", "This week.", "var(--goshtoso-charts-primary)", "var(--goshtoso-charts-surface)", "var(--font-paragraph), sans-serif"} {
