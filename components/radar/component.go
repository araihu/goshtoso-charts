...
func tokenizedSVG(svg string, style charttheme.Style) string {
	replacer := strings.NewReplacer(
		...
		"rgba(5,5,5,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(0))+" 10%, transparent)",
		"rgba(6,6,6,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(1))+" 10%, transparent)",
		"rgba(7,7,7,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(2))+" 10%, transparent)",
		"rgba(8,8,8,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(3))+" 10%, transparent)",
		"rgba(9,9,9,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(4))+" 10%, transparent)",
		"rgba(10,10,10,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(5))+" 10%, transparent)",
		"rgba(11,11,11,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(6))+" 10%, transparent)",
		"rgba(12,12,12,0.078)", "color-mix(in srgb, "+html.EscapeString(style.SeriesColor(7))+" 10%, transparent)",
