...
Primary user and task: Go/templ application developer rendering a concise trend without browser chart runtime.
...
Chosen primitives: native `figure` plus Goshtoso `panel.Panel` supplied by consumer. No public Goshtoso chart primitive matched.
