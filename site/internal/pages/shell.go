...
func shellPage(title string, active string, content templ.Component) componentdocshell.Page {
	return componentdocshell.Page{
		...
		EnableTOC:     active == "getting-started" || active == "line" || active == "bar" || active == "pie" || active == "scatter" || active == "radar" || active == "interactive-bar" || active == "interactive-line" || active == "interactive-tree" || active == "live-availability",
	}
}
