...
var chartAttributions = []attribution{
	{Name: "go-analyze/charts", Version: "v0.6.0; example revision 1fe31b06b8a82e00df877ff4417a75858547c1c2", ProjectURL: "https://github.com/go-analyze/charts", License: "MIT", LicenseURL: "https://github.com/go-analyze/charts/blob/v0.6.0/LICENSE", UsedFor: "Go-native SVG rendering behind static/vector components. Documentation adapts examples/1-Painter/line_chart-5-area/main.go, examples/1-Painter/line_chart-8-dual_y_axis/main.go, examples/1-Painter/horizontal_bar_chart-1-basic/main.go, examples/1-Painter/doughnut_chart-1-basic/main.go, examples/1-Painter/scatter_chart-3-dense_data/main.go, examples/1-Painter/scatter_chart-4-top_n_labels/main.go, examples/1-Painter/radar_chart-1-basic/main.go, examples/1-Painter/candlestick_chart-1-basic/main.go, examples/1-Painter/candlestick_chart-3-bollinger_bands/main.go, examples/1-Painter/candlestick_chart-4-patterns/main.go, examples/1-Painter/funnel_chart-1-basic/main.go, examples/1-Painter/heat_map-1-basic/main.go, examples/1-Painter/table-1/main.go, and examples/1-Painter/violin_chart-2-samples/main.go."},
