...
var chartAttributions = []attribution{
	...
	{Name: "go-echarts", Version: "v2.7.2", ProjectURL: "https://github.com/go-echarts/go-echarts", License: "MIT", LicenseURL: "https://github.com/go-echarts/go-echarts/blob/v2.7.2/LICENSE", UsedFor: "Private Go adapter behind renderer-neutral interactive components. Documentation adapts examples/sunburst.go, examples/treemap.go, examples/parallel.go, and examples/themeriver.go at bda428480a82d6d77ebb9fa939cf8d52528453dd."},
}
