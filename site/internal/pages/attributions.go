...
var chartAttributions = []attribution{
	{Name: "go-analyze/charts", Version: "v0.6.0; example revision 1fe31b06b8a82e00df877ff4417a75858547c1c2", ProjectURL: "https://github.com/go-analyze/charts", License: "MIT", LicenseURL: "https://github.com/go-analyze/charts/blob/v0.6.0/LICENSE", UsedFor: "Go-native SVG rendering behind static/vector components. Documentation adapts examples/1-Painter/horizontal_bar_chart-1-basic/main.go, examples/1-Painter/doughnut_chart-1-basic/main.go, examples/1-Painter/scatter_chart-3-dense_data/main.go, examples/1-Painter/radar_chart-1-basic/main.go, examples/1-Painter/candlestick_chart-1-basic/main.go, examples/1-Painter/funnel_chart-1-basic/main.go, examples/1-Painter/heat_map-1-basic/main.go, examples/1-Painter/table-1/main.go, and examples/1-Painter/violin_chart-2-samples/main.go."},
	{Name: "go-echarts", Version: "v2.7.2", ProjectURL: "https://github.com/go-echarts/go-echarts", License: "MIT", LicenseURL: "https://github.com/go-echarts/go-echarts/blob/v2.7.2/LICENSE", UsedFor: "Private Go adapter behind renderer-neutral interactive components. Documentation adapts examples/kline.go, examples/scatter3d.go, examples/sunburst.go, examples/treemap.go, examples/parallel.go, examples/themeriver.go, examples/wordcloud.go, examples/liquid.go, examples/map.go, and examples/geo.go from go-echarts/examples at bda428480a82d6d77ebb9fa939cf8d52528453dd. Scatter 3D replaces upstream time-seeded randomness with a local fixed seed in the same [0,100) domain; Geo uses fixed literals."},
}
...
var runtimeAttributions = []attribution{
	...
	{Name: "go-echarts map resources", Version: "commit 41f247b1cbb6", ProjectURL: "https://github.com/go-echarts/go-echarts-assets/tree/41f247b1cbb649b029a2d3fffb04f469de372aa7/assets/maps", License: "MIT", LicenseURL: "https://github.com/go-echarts/go-echarts-assets/blob/41f247b1cbb649b029a2d3fffb04f469de372aa7/LICENSE", UsedFor: "Pinned national and Guangdong geometry resources bundled for local interactive-map rendering."},
}
