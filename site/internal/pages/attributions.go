...
var chartAttributions = []attribution{
	{Name: "go-analyze/charts", Version: "v0.6.0; example revision 1fe31b06b8a82e00df877ff4417a75858547c1c2", ProjectURL: "https://github.com/go-analyze/charts", License: "MIT", LicenseURL: "https://github.com/go-analyze/charts/blob/v0.6.0/LICENSE", UsedFor: "Go-native SVG rendering behind static/vector components. The Line component covers examples/1-Painter/line_chart-1-basic/main.go through line_chart-10-gradient_labels/main.go, including examples/1-Painter/line_chart-5-area/main.go and examples/1-Painter/line_chart-8-dual_y_axis/main.go; immutable per-file source hashes and adaptation notes are centralized in docs/upstream-example-coverage.md. Other documentation adapts examples/1-Painter/horizontal_bar_chart-1-basic/main.go, examples/1-Painter/bar_chart-4-mark/main.go, examples/1-Painter/doughnut_chart-1-basic/main.go, examples/1-Painter/scatter_chart-3-dense_data/main.go, examples/1-Painter/scatter_chart-4-top_n_labels/main.go, examples/1-Painter/radar_chart-1-basic/main.go, examples/1-Painter/candlestick_chart-1-basic/main.go, examples/1-Painter/candlestick_chart-3-bollinger_bands/main.go, examples/1-Painter/candlestick_chart-4-patterns/main.go, examples/1-Painter/candlestick_chart-5-aggregation/main.go, examples/1-Painter/funnel_chart-1-basic/main.go, examples/1-Painter/heat_map-1-basic/main.go, examples/1-Painter/table-1/main.go, and examples/1-Painter/violin_chart-2-samples/main.go."},
	{Name: "go-echarts", Version: "v2.7.2", ProjectURL: "https://github.com/go-echarts/go-echarts", License: "MIT", LicenseURL: "https://github.com/go-echarts/go-echarts/blob/v2.7.2/LICENSE", UsedFor: "Private Go adapter behind renderer-neutral interactive components. Documentation adapts the full examples/line.go surface plus examples/pie.go, examples/kline.go, examples/scatter3d.go, examples/bar3d.go, examples/surface3d.go, examples/line3d.go, examples/sunburst.go, examples/treemap.go, examples/parallel.go, examples/themeriver.go, examples/wordcloud.go, examples/liquid.go, examples/map.go, and examples/geo.go from go-echarts/examples at bda428480a82d6d77ebb9fa939cf8d52528453dd. Line uses deterministic category, numerical, and UTC temporal values; corrects the upstream Peach label typo; records mixed line/scatter composition as an explicit renderer-neutral API gap; and centralizes source evidence in docs/upstream-example-coverage.md. Pie replaces ambient random values with a fixed local seed sequence in the same [0,100) domain and trims an upstream season-name typo. Scatter 3D replaces upstream time-seeded randomness with a local fixed seed in the same [0,100) domain; Bar 3D preserves the upstream X/Y index swap; Surface 3D preserves both ordered mathematical grids; Line 3D preserves the exact ordered parametric path and both view treatments; Geo uses fixed literals."},
}
