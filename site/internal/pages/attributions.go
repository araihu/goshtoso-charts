...
var chartAttributions = []attribution{
	...
	{Name: "go-echarts", Version: "v2.7.2", ProjectURL: "https://github.com/go-echarts/go-echarts", License: "MIT", LicenseURL: "https://github.com/go-echarts/go-echarts/blob/v2.7.2/LICENSE", UsedFor: "Private Go adapter behind renderer-neutral interactive components. Documentation adapts examples/line.go (lineTime and generateLineItemsTwoAxis), examples/pie.go, examples/kline.go, examples/scatter3d.go, examples/bar3d.go, examples/surface3d.go, examples/line3d.go, examples/sunburst.go, examples/treemap.go, examples/parallel.go, examples/themeriver.go, examples/wordcloud.go, examples/liquid.go, examples/map.go, and examples/geo.go from go-echarts/examples at bda428480a82d6d77ebb9fa939cf8d52528453dd. Temporal Line replaces ambient random values and local time with a fixed local generator and UTC while preserving the 100–119 value domain and normalized February day offsets. Pie replaces ambient random values with a fixed local seed sequence in the same [0,100) domain and trims an upstream season-name typo. Scatter 3D replaces upstream time-seeded randomness with a local fixed seed in the same [0,100) domain; Bar 3D preserves the upstream X/Y index swap; Surface 3D preserves both ordered mathematical grids; Line 3D preserves the exact ordered parametric path and both view treatments; Geo uses fixed literals."},
}
