...
func TestDocumentationSearchIndexesCategorizedNavigation(t *testing.T) {
	...
	for _, want := range []string{
		...
		`data-search="chart controls general chart-controls wrapper lifecycle enabled disabled hidden omitted client events javascript alpine htmx export svg png fullscreen"`,
