...
func TestDocumentationSearchIndexesCategorizedNavigation(t *testing.T) {
	...
	for _, want := range []string{
		...
		`data-search="getting started general getting-started choose chart mode wrapper controls static vector interactive"`,
		`data-search="static and interactive general chart-modes static vector interactive capabilities use cases delivery runtime print"`,
		`data-search="chart controls general chart-controls wrapper lifecycle mode enabled disabled hidden omitted no wrapper dom state attributes client events javascript alpine htmx no javascript export svg png fullscreen"`,
		...
		`data-search="scatter 3d interactive / 3d interactive-scatter-3d"`,
		`data-search="bar 3d interactive / 3d interactive-bar-3d"`,
		`data-search="surface 3d interactive / 3d interactive-surface-3d"`,
		`data-search="line 3d interactive / 3d interactive-line-3d"`,
		...
		`data-search="geo interactive / geographic interactive-geo"`,
		...
		`data-search="treemap interactive / relationships interactive-treemap"`,
