...
const chartTokens = [
  ...
  "--color-chart-foreground-strong",
  "--color-chart-foreground-muted",
  "--color-chart-text",
  "--color-chart-text-strong",
  "--color-chart-text-muted",
  "--color-chart-pattern-text",
  "--color-chart-pattern-surface",
  "--color-chart-pattern-outline",
  ...Array.from({ length: 12 }, (_, index) => `--color-chart-series-${index + 1}`),
  ...
  "--color-chart-danger",
  "--color-chart-info",
  ...Array.from({ length: 5 }, (_, index) => `--color-chart-sequential-${index + 1}`),
  ...Array.from({ length: 5 }, (_, index) => `--color-chart-diverging-${index + 1}`),
    ...
    for (const theme of builtInThemes) {
      ...
      for (const scheme of ["light", "dark"]) {
        ...
        const paletteSignature = [
          ...Array.from({ length: 12 }, (_, index) => tokens[`--color-chart-series-${index + 1}`].rgba.join(",")),
